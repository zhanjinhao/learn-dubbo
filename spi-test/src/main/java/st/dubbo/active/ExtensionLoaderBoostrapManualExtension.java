 ...
 * @Date 2022/3/7 18:08
 */
public class ExtensionLoaderBoostrapManualExtension {
    ...
    public static void main(String[] args) {
        ...
        List<PrintService> default_group = extensionLoader.getActivateExtension(url, new String[]{"jdk"}, "order");
        ...
        System.out.println(default_group.get(2).getClass());

        default_group.get(2).printInfo("hello world", url);
